...
function ecommerce_star_general_admin_notice(){
         ...
         $msg = sprintf('<div data-dismissible="disable-done-notice-forever" class="notice notice-info" >
				...
				esc_html__('Use a page builder and Drag widgets starting prefix Theme: ex:- product slider, product categories to create your site. See recommended actions.','ecommerce-star'),	
				esc_html__('Dismiss', 'ecommerce-star'));
		 echo wp_kses_post($msg);
}

if ( isset( $_GET['ecommerce_star_notice_dismissed'] ) ){
	update_option('ecommerce_star_admin_notice', -1);
}

$ecommerce_star_admin_notice = get_option('ecommerce_star_admin_notice', 1);
...
if (($ecommerce_star_admin_notice > 0 || $ecommerce_star_admin_notice == '') && !$ecommerce_star_refreshed ){
